        ...
        for f in allfolds:
            ...
            if (modelflag):
                if(modifiedflag==True):
                    model, model_noft = getmodel_resnet.build_model_doublelayer_modified(trainX_balanced, trainY_balanced,
                    ...
                    model, model_noft = getmodel_resnet.build_model_doublelayer(trainX_balanced, trainY_balanced,
